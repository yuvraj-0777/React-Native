...
export const playListData : Track[] = [
    {
      ...
      url: require('./assets/audios/One.mp3'),
    },
    {
      id: 2,
      ...
      url: require('./assets/audios/CheepThrills.mp3'),
    },
    {
      id: 3,
      title: 'Kesariya',
    ...
    },
    {
      ...
      url: require('./assets/audios/NeverLetYouGo.mp3'),
    },
    {
      id: 5,
      title: 'Besharam Rang',
      ...
      url: require('./assets/audios/QueenofHearts.mp3'),
    },
  ];
